...
class profileForStudent extends StatefulWidget {
  const profileForStudent({super.key});

  @override
  State<profileForStudent> createState() => _profileForStudentState();
}

class _profileForStudentState extends State<profileForStudent> {
  @override
  ...
  Widget buildEditB() => ButtonWidget(
        ...
        onClicked: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => EditStudentProfile()));
        },
      );
}
